...
// define the constructor to create the objects
...
// call the constructor function to generate the objects and store it into a variable.
...
// define the item array with all of the object variables
let items = [switchConsole, dsConsole, joyCon, proCon, smashBro, marioKart];

// defining html elements to use later
...
// define and initialize global variables to be used by all of the functions
let cartItems =[];
let cartQty = [];
let filter = [];
let cartTotal = 0;

// on page load function calls to set up the page
displayContent(items); // function to display the array in the content div
addCartButton(items); // function to link cart buttons to each product's div
emptyCart();

// this function creates an event listener for each product's button
